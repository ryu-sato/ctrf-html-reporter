...
program
  ...
  .option('-p, --previous-reports <path or glob pattern or directory>', 'Path to previous CTRF report file(s) or directory for comparison', DEFAULT_PREVIOUS_REPORT_PATHS)
